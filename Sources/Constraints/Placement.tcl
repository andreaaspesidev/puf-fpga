...
for { set INSTANCE_NUM  0} {$INSTANCE_NUM < $NUM_INSTANCES} {incr INSTANCE_NUM} {
    ...
    if { $INSTANCE_NUM == 0 } {
        ...
        incr X4 3
        set Y  $PUF_START_Y
    } elseif { $INSTANCE_NUM == 384} { #400-16
    ...
    if { $INSTANCE_NUM % 4 == 0 } { 
        ...
        # --- LUT1 enables
        set_property FIXED_ROUTE { { CLBLM_M_BQ CLBLM_LOGIC_OUTS5 IMUX18 CLBLM_M_B2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable1]
        set_property FIXED_ROUTE { { CLBLM_M_CQ CLBLM_LOGIC_OUTS6 IMUX29 CLBLM_M_C2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable2]
        # --- LUT2 enables
        set_property FIXED_ROUTE { { CLBLM_M_AQ CLBLM_LOGIC_OUTS4 IMUX1 CLBLM_M_A3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable1]
        set_property FIXED_ROUTE { { CLBLM_M_DQ CLBLM_LOGIC_OUTS7 IMUX38 CLBLM_M_D3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable2]
        # --- OR to first FF clk (needed?)
        # ored_out_[expr {$INSTANCE_NUM / 2}]
        set_property FIXED_ROUTE { { CLBLM_M_A CLBLM_LOGIC_OUTS12 NL1BEG_N3 FAN_ALT5 FAN_BOUNCE5 CLK1 CLBLM_M_CLK }  } [ get_nets PUF_inst/Core_inst/ored_out[[expr {$INSTANCE_NUM / 2}]] ]
    } elseif { $INSTANCE_NUM % 4 == 1 } { 
        # second column
        # --- LUT1 NOT output
        ...
        # --- LUT1 enables
        set_property FIXED_ROUTE { { CLBLM_L_BQ CLBLM_LOGIC_OUTS1 IMUX19 CLBLM_L_B2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable1]
        set_property FIXED_ROUTE { { CLBLM_L_CQ CLBLM_LOGIC_OUTS2 IMUX20 CLBLM_L_C2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable2]
        # --- LUT2 enables
        set_property FIXED_ROUTE { { CLBLM_L_AQ CLBLM_LOGIC_OUTS0 IMUX0 CLBLM_L_A3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable1]
        set_property FIXED_ROUTE { { CLBLM_L_DQ CLBLM_LOGIC_OUTS3 IMUX39 CLBLM_L_D3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable2]
    } elseif { $INSTANCE_NUM % 4 == 2 } { 
        # third column
        # --- LUT1 NOT output
        ...
        # --- LUT1 enables
        set_property FIXED_ROUTE { { CLBLL_LL_BQ CLBLL_LOGIC_OUTS5 IMUX_L18 CLBLL_LL_B2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable1]
        set_property FIXED_ROUTE { { CLBLL_LL_CQ CLBLL_LOGIC_OUTS6 IMUX_L29 CLBLL_LL_C2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable2]
        # --- LUT2 enables
        set_property FIXED_ROUTE { { CLBLL_LL_AQ CLBLL_LOGIC_OUTS4 IMUX_L1 CLBLL_LL_A3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable1]
        set_property FIXED_ROUTE { { CLBLL_LL_DQ CLBLL_LOGIC_OUTS7 IMUX_L38 CLBLL_LL_D3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable2]
        # --- OR to first FF clk (needed?)
        ...
        # --- LUT1 enables
        set_property FIXED_ROUTE { { CLBLL_L_BQ CLBLL_LOGIC_OUTS1 IMUX_L19 CLBLL_L_B2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable1]
        set_property FIXED_ROUTE { { CLBLL_L_CQ CLBLL_LOGIC_OUTS2 IMUX_L20 CLBLL_L_C2 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop1_enable2]
        # --- LUT2 enables
        set_property FIXED_ROUTE { { CLBLL_L_AQ CLBLL_LOGIC_OUTS0 IMUX_L0 CLBLL_L_A3 }  } [get_nets PUF_inst/Core_inst/gen_TEROS[$INSTANCE_NUM].TEROS/loop2_enable1]
